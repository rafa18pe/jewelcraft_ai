...
/// A class that contains all theme configurations for the jewelry design application.
class AppTheme {
  AppTheme._();

  // Precious Metal Palette - Color specifications
  static const Color primaryLight = Color(0xFFB8860B); // Warm gold tone
  static const Color primaryVariantLight = Color(0xFF9A7209); // Darker gold
  static const Color secondaryLight = Color(0xFF708090); // Refined silver-gray
  static const Color secondaryVariantLight =
      Color(0xFF5A6B7A); // Darker silver-gray
  ...
  static const Color warningLight = Color(0xFFDAA520); // Goldenrod
  static const Color accentLight = Color(0xFFCD853F); // Warm bronze
  static const Color onPrimaryLight = Color(0xFFFFFFFF);
  static const Color onSecondaryLight = Color(0xFFFFFFFF);
  static const Color onBackgroundLight = Color(0xFF2C2C2C); // Deep charcoal
  static const Color onSurfaceLight = Color(0xFF2C2C2C); // Deep charcoal
  static const Color onErrorLight = Color(0xFFFFFFFF);

  static const Color primaryDark =
      Color(0xFFDAA520); // Lighter gold for dark theme
  static const Color primaryVariantDark = Color(0xFFB8860B); // Original gold
  static const Color secondaryDark = Color(0xFF9CA3AF); // Lighter silver-gray
  static const Color secondaryVariantDark =
      Color(0xFF708090); // Original silver-gray
  ...
  static const Color successDark =
      Color(0xFF4ADE80); // Lighter green for dark theme
  static const Color warningDark =
      Color(0xFFFBBF24); // Lighter goldenrod for dark theme
  static const Color accentDark =
      Color(0xFFD2691E); // Lighter bronze for dark theme
  ...
  // Divider colors - space-defining approach
  static const Color dividerLight =
      Color(0x33708090); // Secondary color at 20% opacity
  static const Color dividerDark =
      Color(0x339CA3AF); // Secondary dark color at 20% opacity
  ...
  static const Color textPrimaryDark = Color(0xFFFAFAFA); // Soft white
  ...
  /// Helper method to get monospace text style for data/measurements
